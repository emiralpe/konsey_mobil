import { SafeAreaView, StyleSheet, Text, TouchableOpacity, View, TextInput, Modal } from 'react-native'
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            try {
                ...
                const response = await fetch('http://192.168.0.210:3000/api/events/get', {
                    method: 'GET',
                    headers: {
